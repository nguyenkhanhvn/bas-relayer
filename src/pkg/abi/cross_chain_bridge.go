...
// IsPeggedToken is a free data retrieval call binding the contract method 0x5f35e68e.
//
// Solidity: function isPeggedToken(address fromToken) view returns(bool)
func (_CrossChainBridge *CrossChainBridgeCaller) IsPeggedToken(opts *bind.CallOpts, fromToken common.Address) (bool, error) {
	var out []interface{}
	err := _CrossChainBridge.contract.Call(opts, &out, "isPeggedToken", fromToken)
...
//
// Solidity: function isPeggedToken(address fromToken) view returns(bool)
func (_CrossChainBridge *CrossChainBridgeSession) IsPeggedToken(fromToken common.Address) (bool, error) {
	return _CrossChainBridge.Contract.IsPeggedToken(&_CrossChainBridge.CallOpts, fromToken)
}

// IsPeggedToken is a free data retrieval call binding the contract method 0x5f35e68e.
//
// Solidity: function isPeggedToken(address fromToken) view returns(bool)
func (_CrossChainBridge *CrossChainBridgeCallerSession) IsPeggedToken(fromToken common.Address) (bool, error) {
	return _CrossChainBridge.Contract.IsPeggedToken(&_CrossChainBridge.CallOpts, fromToken)
}
